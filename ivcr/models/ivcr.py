...
class IVCR(Blip2Base):
    ...
    def __init__(
        ...
        # DEFAULT_VIDEO_END_TOKEN = "</Video>"
        self.llama_tokenizer.add_tokens([DEFAULT_IMAGE_PATCH_TOKEN], special_tokens=True)
        # self.llama_tokenizer.add_tokens([DEFAULT_VIDEO_TOKEN], special_tokens=True)
        # self.llama_tokenizer.add_tokens([DEFAULT_VIDEO_END_TOKEN], special_tokens=True)
        self.IMAGE_PATCH_TOKEN_ID = self.llama_tokenizer.get_vocab()[DEFAULT_IMAGE_PATCH_TOKEN]
        # self.VIDEO_TOKEN_ID = self.llama_tokenizer.get_vocab()[DEFAULT_VIDEO_TOKEN]
        # self.VIDEO_END_TOKEN_ID =self.llama_tokenizer.get_vocab()[DEFAULT_VIDEO_END_TOKEN]
